...
source_folder = '/content/drive/MyDrive/Vietnamese-license-plate-recognition'                          # Folder contains input image and two model
...
while(cap.isOpened()):
    ...
    if ret:
        ...
        cv2.imshow("Predict the license plate",predict_image)
